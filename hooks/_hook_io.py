...
def plugin_root(argv, hook_dir):
    ...
    2. $CLAUDE_PLUGIN_ROOT from the environment, which a hook run inherits
    3. the hooks directory's parent, which holds for every shipped layout
    ...
    candidates.append(os.environ.get("CLAUDE_PLUGIN_ROOT"))
